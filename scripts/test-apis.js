...
async function runTests() {
  const tests = [
    ...
    { name: "Admin Stats Load", url: "http://localhost:8099/api/admin/stats", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Tools List", url: "http://localhost:8099/api/admin/tools", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Settings Get", url: "http://localhost:8099/api/admin/settings", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Blogs Get", url: "http://localhost:8099/api/admin/blogs", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Articles Get", url: "http://localhost:8099/api/admin/articles", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Comments Get", url: "http://localhost:8099/api/admin/comments", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Ratings Get", url: "http://localhost:8099/api/admin/ratings", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },
    { name: "Admin Contacts Get", url: "http://localhost:8099/api/admin/contacts", method: "GET", status: 200, headers: { Authorization: "Bearer admin123" } },

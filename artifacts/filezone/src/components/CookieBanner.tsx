...
export function CookieBanner() {
  ...
  return (
    <div 
      className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6 animate-in slide-in-from-bottom-4 duration-300 transform-gpu"
    ...
    >
      <div className="max-w-4xl mx-auto bg-card border rounded-2xl shadow-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              We use cookies to display ads and improve your experience. By clicking "Accept", you consent to our use of cookies as detailed in our{" "}
        ...
        <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
          ...
          <button onClick={decline} aria-label="Close cookie consent banner" className="p-1 text-muted-foreground hover:text-foreground transition-colors">
            <X className="h-4 w-4" />
          </button>
        </div>
      </div>
